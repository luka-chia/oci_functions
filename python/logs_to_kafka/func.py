...
def handler(ctx, data: io.BytesIO = None):
    ...
    try:
        topic_name = 'test'
        bootstrap_server = 'kafka.sub09130932481.vcn.oraclevcn.com'
    ...
    try:
        sent_logs = publish_message(topic=topic_name, bootstrap_srv=bootstrap_server,  record_value=bytes(str(body[0]), encoding='utf-8'))
...
def publish_message(topic, bootstrap_srv, record_value):
    conf = {
